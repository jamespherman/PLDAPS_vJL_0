function p = reward_calibration_settings
%  p = reward_calibration_settings
%
...
p.init.taskName         = 'reward_calibration';
...
p.init.exptType         = 'reward_calibration';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
