function p = scd_settings_satInc
%  p = scd_settings_satInc
%
...
p.init.exptType         = 'saturationIncrease';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
...
p.init.strobeList = fliplr({...                 
    ...
    'p.trVars.stimLoc1Ecc*10',                                                                                  'stimLoc1Ecc'; ...
    'p.trVars.stimLoc2Ecc*10',                                                                                  'stimLoc2Ecc'; ...
