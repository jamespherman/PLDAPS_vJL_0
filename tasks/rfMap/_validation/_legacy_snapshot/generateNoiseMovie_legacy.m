function [noiseMovie, rngSeed] = generateNoiseMovie_legacy(nChecksY, nChecksX, ...
    nFrames, colorMode, isBinary, rngSeed, stimMode, nSparseSpots)
% generateNoiseMovie_legacy  Frozen pre-merge generator for regression.
%
% Snapshot of supportFunctions/generateNoiseMovie.m at the
% rfMap-pre-unified-merge tag. Used by
% _validation/compare_old_vs_new_generators.m as the "old" reference
% in the bit-exact regression contract. Do not edit beyond the rename.
%
