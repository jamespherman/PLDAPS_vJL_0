function p = gSac_contrast_settings
%  p = gSac_contrast_settings
%
%   gSac_contrast task
% =============
...
p.init.exptType         = 'gSac_contrast';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
