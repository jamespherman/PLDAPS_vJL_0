function p = numerosity_settings_spatial
%  p = numerosity_settings_spatial
%
%   numerosity task
% =============
...
p.state.holdTarg            = 7;
p.state.sacComplete	    = 8;

% end states - success:
p.state.correctTarget       = 21;
...
p.status.visTrialsOneStimNumHits    = 0;
p.status.visTrialsOneStimNumMisses  = 0;
p.status.visTrialsTwoStimNumHits    = 0;
p.status.visTrialsTwoStimNumMisses  = 0;

p.status.microstimTrials                    = 0;
p.status.microstimTrialsOneStimNumHits      = 0;
p.status.microstimTrialsOneStimNumMisses    = 0;
p.status.microstimTrialsTwoStimNumHits      = 0;
p.status.microstimTrialsTwoStimNumMisses    = 0;

p.rig.guiStatVals = {...   
    'iTrial'; ...
    'visTrials'; ...
    'visTrialsOneStimNumHits'; ...
    'visTrialsOneStimNumMisses'; ...
    'visTrialsTwoStimNumHits'; ...
    'visTrialsTwoStimNumMisses'; ...
    'microstimTrials'; ...
    'microstimTrialsOneStimNumHits'; ...
    'microstimTrialsOneStimNumMisses'; ...
    'microstimTrialsTwoStimNumHits'; ...
    'microstimTrialsTwoStimNumMisses'; ...
    'trialsLeftInBlock'; ...   
};              
...
p.trVarsInit.targHoldDuration        = 0.3;  % minimum duration to maintain fixation on the target post-saccade 
...
p.trVarsInit.totalFixDur             = 0.9; % Total duration from FixAq to FixOff (go cue)
p.trVarsInit.stimOnsetMin	         = 0.3; % Minimum time after fixation before stim comes on
p.trVarsInit.targOnsetMin            = 0.15; % Minimum time after stim goes off before target onset
...
p.trVarsInit.stopIfNotRecording      = true;
...
p.draw.color.fixWhenOn      = p.draw.clutIdx.expRed_subRed;                 % fixation CLUT index
...
p.init.strobeList = {...
    ...
    'microStimChannel', 'p.trVars.stimElectrode2'; ...
