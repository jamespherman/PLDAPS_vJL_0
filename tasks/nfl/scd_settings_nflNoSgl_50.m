function p = scd_settings_nflNoSgl_50
...
p.init.exptType         = 'nfl_50';  % Which experiment are we running? The one in which there are only saturation increase events to detect in the first block, then a 50/50 split of sat. inc. and contrast inc.
