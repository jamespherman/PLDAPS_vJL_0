function p = scd_settings_nflNoSgl_shortBlocks
%  p = scd_settings_nflNoSgl
%
...
p.init.exptType         = 'nfl_shortBlocks';  % Which experiment are we running? The one in which there are only saturation increase events to detect in the first block, then a 50/50 split of sat. inc. and contrast inc.
...
% The function pds.strobeVars takes this list and strobes a code that 
...
p.init.strobeList = fliplr({...
    ...
    'p.init.codes.uniqueTaskCode_nfl',                          'taskCode'; ...
    'p.trVars.cueOn',                                           'cueStimIsOn'; ...
    'p.trVars.foilOn',                                          'foilStimIsOn'; ...
    'p.init.trialsArray(p.trVars.currentTrialsArrayRow, 9)',    'trialCode'; ...
    'p.trVars.trialSeed',                                       'randSeedTrial'; ...
    'p.trVars.stimSeed',                                        'randSeedStim'; ...
    'p.trVars.isContrastChangeTrial',                           'isContrastChangeTrial'; ...
    });
end