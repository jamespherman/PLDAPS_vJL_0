...
userFolders = mydir('/Users/');
userDir = userFolders(~ismember(userFolders, {'.localized','Shared','Guest','aahermanjp','aawalkerjj','jclapps', 'itsupport'}));

otherDir      = ['/Users/' userDir{:} '/Google Drive/Monkeys/other/'];
