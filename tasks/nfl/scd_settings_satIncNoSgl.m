function p = scd_settings_satIncNoSgl
%  p = scd_settings_nfl
%
...
p.init.exptType         = 'saturation increase no single';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
