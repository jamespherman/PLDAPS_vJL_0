...
p.trVarsInit.targDegX            = 17;  % default target X location if one isn't specified by other means
p.trVarsInit.targDegY            = 3;    % default target Y location if one isn't specified by other means
p.trVarsInit.targDegX_base       = 17;  % default target X location if one isn't specified by other means
p.trVarsInit.targDegY_base       = 3;    % default target Y location if one isn't specified by other means
