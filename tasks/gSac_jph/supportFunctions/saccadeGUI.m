...
uiData.handles.hSpikeRateAxesTargetOnset   =   axes(...
    ...
    'Parent', uiData.handles.hGui, ...
    'Units', 'normalized', ...
    'Position', uiData.handles.hSpikeRasterAxesTargetOnset.Position, ...
    'HandleVisibility', 'callback', ...
    'FontSize', 10, ...
    'TickDir', 'Out', ...
    'TickLength', [0.005 0.025], ...
...
% HERE YOU ARE. Use uiData.spikesAndEvents to update rasters and spike rate
% plots. Consult "updateRasters" in "heatMapPlotGUI".
