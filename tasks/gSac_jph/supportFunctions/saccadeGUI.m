...
function colorpSelect_callback(hObject, eventdata, uiData)
...
uiData.handles.hColorBarAxes       =   axes(...  % HeatMap colorbar axes
    ...
    'Units', 'normalized', ...
    'HandleVisibility', 'callback', ...
    'Position', [0.875 0.325 0.035 0.65], ...
    'CLim', [0 1], ...
    'CLimMode', 'manual', ...
    'FontSize', 14, ...
    'TickDir', 'Out', ...
...
uiData.handles.hColorMapSelectionPanel  = uipanel(...
    ...
    'BackGroundColor', [1 1 1], ...
    'ShadowColor', [0 0 1], ...
    'Position', [0.43 0.01 0.125 0.275]);
...
uiData.handles.hColorMapSelectionList    = uicontrol(...
    ...
    'Value', 3, ...
    'Callback', {@colorpSelect_callback, uiData});
...
uiData.handles.hSavePanel       = uipanel(...
    ...
    'ShadowColor', [0 1 0], ...
    'BackGroundColor', [1 1 1], ...
    'Position',[0.775 0.01 0.215 0.275]);
