...
p.init.exptType         = 'denseNoise';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
...
p.trVarsInit.numPresentations = 10;
p.trVarsInit.presentationDur = 0.05; % in s
p.trVarsInit.pauseDur = 0; % in s
p.trVarsInit.squareSize = 0.5; % in dva
