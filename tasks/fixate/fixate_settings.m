...
p.trVarsInit.fixWinWidthDeg       = 8;        % fixation window width in degrees
p.trVarsInit.fixWinHeightDeg      = 8;        % fixation window height in degrees
