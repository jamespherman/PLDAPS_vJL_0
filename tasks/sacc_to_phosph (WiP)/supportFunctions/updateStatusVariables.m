...
p.status.visNumHits = p.status.visNumHits + (p.trVars.trialType == 1 && ...
                                             p.trData.trialEndState == p.state.sacComplete);

p.status.visNumMisses = p.status.visNumMisses + (p.trVars.trialType == 1 && ...
                                                 p.trData.trialEndState == p.state.heldFix);
...
p.status.correctRejects = p.status.correctRejects + (p.trVars.trialType == 3 && ...
                                                  p.trData.trialEndState == p.state.heldFix);

p.status.falseAlarms = p.status.falseAlarms + (p.trVars.trialType == 3 && ...
                                               p.trData.trialEndState == p.state.sacComplete);
