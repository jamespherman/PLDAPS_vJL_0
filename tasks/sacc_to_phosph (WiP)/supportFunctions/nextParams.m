...
p.trVars.targDegX	= p.trVars.stimDegX;
...
p.trVars.visStimShape = randsample (["oval", "rect"], 1);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if p.trVars.visStimShape == "oval"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif p.trVars.visStimShape == "rect"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
kernelSize = 0.1*(p.draw.stimWidth + p.draw.stimHeight); % Larger means more spread
sigma = 5; % Larger means more blur
...
%{
% Check that stimAmplitude is not >200uA, as we are not stimulating above that
if p.trVars.stimAplitude >200
    error ('Stimulation amplitude is greater than 200 uA');
end

% Convert current amplitude to steps, then overwrite stimAmplitude with
% rounded value in case of odd numbers (since number of steps must be a
% whole number, and we are using a step size of 2)
...
if p.trVars.stimAmplitude > 210
    ...
    error ('Stimulation amplitude is greater than 210 uA');
