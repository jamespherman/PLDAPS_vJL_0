...
table = [
    ...
    1 2 false 1 4 24004; ... % one dots, two targets, targets diff color, oval stim, 3 reps, 24004 trial code  
    ...
    1 2 false 2 4 24004; ... % one dots, two targets, targets diff color, rect stim, 3 reps, 24004 trial code  
