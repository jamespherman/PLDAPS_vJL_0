...
table = [
    ...
    2 2 false 1 5 24008; ... % two dots, two targets, targets diff color, oval stim, 3 reps, 24008 trial code
    ...
    2 2 false 2 5 24008; ... % two dots, two targets, targets diff color, rect stim, 3 reps, 24008 trial code       
    ];
end
