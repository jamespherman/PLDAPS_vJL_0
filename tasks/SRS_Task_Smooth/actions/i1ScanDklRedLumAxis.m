...
% found, put them in srsSmooth_settings.m as:
%   p.trVarsInit.luminanceRedDklLow  = <suggested low>;
%   p.trVarsInit.luminanceRedDklHigh = <suggested high>;
%
% Recommended call from srsSmooth_run measurement mode:
...
if any(validMeasured)
    ...
    fprintf('\nCopy these into srsSmooth_settings.m after checking with James:\n');
