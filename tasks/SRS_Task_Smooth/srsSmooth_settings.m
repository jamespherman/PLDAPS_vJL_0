...
p.status.previousTargetDelayDurationMs = NaN; % prevents identical consecutive go delays
...
p.trVarsInit.targetDelayDurationMs       = 450;      % sampled once per trial by nextParams; never resampled inside the display loop
...
p.init.trDataInitList = {...
    ...
    'p.trData.timing.fixBreakDuringDelay','-1'; ...
    ...
    'p.trData.failureReason',            '""'; ...
    'p.trData.feedbackTone',             '""'; ...
    'p.trData.landingEyeDegX',           'NaN'; ...
    'p.trData.landingEyeDegY',           'NaN'; ...
...
p.init.strobeList = {...                
    ...
    'correctionRightRewardReductionLevel', ...
        'p.trVars.correctionRightRewardReductionLevel'; ...
    ...
    'correctionOriginalRightRewardMs', ...
        'p.trVars.correctionOriginalRightRewardMs'; ...
