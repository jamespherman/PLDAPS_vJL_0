function p = joystick_release_for_stim_change_and_dim_settings_TEST
%  p = joystick_release_for_stim_change_and_dim_settings_TEST
...
p.init.exptType         = 'joystick_release_for_stim_dim_and_feature_change_TEST';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
