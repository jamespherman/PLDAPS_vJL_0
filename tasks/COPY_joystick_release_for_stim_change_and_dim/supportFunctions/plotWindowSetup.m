...
if isfield(p.trVarsInit, 'wantOnlinePlots') && p.trVarsInit.wantOnlinePlots
    ...
    xlabel(p.draw.onlineSplitCuePerfPlotAxes, 'Stimulus Change Type', 'FontSize', 16);
    ...
    p.draw.onlineSplitCuePerfFillObj(2) = fill(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil1-barHalfWidth, xPosFoil1+barHalfWidth, xPosFoil1+barHalfWidth, xPosFoil1-barHalfWidth, xPosFoil1-barHalfWidth], yDataPlaceholder, 0.7*[1 1 1], 'EdgeColor', 'None');
    p.draw.onlineSplitCuePerfPlotObj(2) = plot(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil1, xPosFoil1], [NaN, NaN], 'Color', [0 0 0], 'LineWidth', 2);
    
    % For Location 2 (Foil Only)
    p.draw.onlineSplitCuePerfFillObj(3) = fill(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil2-barHalfWidth, xPosFoil2+barHalfWidth, xPosFoil2+barHalfWidth, xPosFoil2-barHalfWidth, xPosFoil2-barHalfWidth], yDataPlaceholder, 0.7*[1 1 1], 'EdgeColor', 'None');
    p.draw.onlineSplitCuePerfPlotObj(3) = plot(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil2, xPosFoil2], [NaN, NaN], 'Color', [0 0 0], 'LineWidth', 2);
    
    % For Location 3 (Cued and Foil)
    ...
    p.draw.onlineSplitCuePerfFillObj(5) = fill(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil3-barHalfWidth, xPosFoil3+barHalfWidth, xPosFoil3+barHalfWidth, xPosFoil3-barHalfWidth, xPosFoil3-barHalfWidth], yDataPlaceholder, 0.7*[1 1 1], 'EdgeColor', 'None');
    p.draw.onlineSplitCuePerfPlotObj(5) = plot(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil3, xPosFoil3], [NaN, NaN], 'Color', [0 0 0], 'LineWidth', 2);
    
    % For Location 4 (Foil Only)
    p.draw.onlineSplitCuePerfFillObj(6) = fill(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil4-barHalfWidth, xPosFoil4+barHalfWidth, xPosFoil4+barHalfWidth, xPosFoil4-barHalfWidth, xPosFoil4-barHalfWidth], yDataPlaceholder, 0.7*[1 1 1], 'EdgeColor', 'None');
    p.draw.onlineSplitCuePerfPlotObj(6) = plot(p.draw.onlineSplitCuePerfPlotAxes, [xPosFoil4, xPosFoil4], [NaN, NaN], 'Color', [0 0 0], 'LineWidth', 2);
