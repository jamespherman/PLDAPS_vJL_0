...
statusLines = { ...
    ...
    htmlLine('Instruction order', instructionOrder, '#7f6000'); ...
...
%INSTRUCTIONORDERSTRING Describe the two uninterrupted single-target groups.

firstTarget = getNumericField(status, 'FirstSingleTargetID', NaN);
secondTarget = getNumericField(status, 'SecondSingleTargetID', NaN);
...
targetID = getNumericField(status, 'ActiveSingleTargetID', NaN);
