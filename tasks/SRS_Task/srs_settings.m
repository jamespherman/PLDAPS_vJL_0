...
p.init.taskActions{9} = 'i1LivePhotometer';
p.init.taskActions{10} = 'i1MeasureSrsRedLumRamp';
...
p.init.exptType         = 'srs_standard';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
...
p.trVarsInit.targetHorizontalEccDeg = 10;
