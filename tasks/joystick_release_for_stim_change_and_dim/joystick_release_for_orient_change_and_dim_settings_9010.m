function p = joystick_release_for_orient_change_and_dim_settings_9010
%  p = joystick_release_for_orient_change_and_dim_settings_9010
...
p.init.exptType         = 'joystick_release_for_stim_dim_and_orient_change_9010';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
...
p.trVarsInit.cue2StimIntvlMin        = 0;       % Minimum time between cue presentation (offset) and stimulus onset.
p.trVarsInit.cue2StimIntvlWin        = 0;       % Duration of possible stimulus onset window after cue presentation (between "min" and "min + win").
