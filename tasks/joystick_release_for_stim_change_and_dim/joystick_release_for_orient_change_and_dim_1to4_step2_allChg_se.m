function p = joystick_release_for_orient_change_and_dim_1to4_step2_allChg_settings
%  p = joystick_release_for_orient_change_and_dim_1to4_step2_allChg_settings
...
p.init.exptType         = 'joystick_release_for_stim_dim_and_orient_change_1to4_train_step2_allChg';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
