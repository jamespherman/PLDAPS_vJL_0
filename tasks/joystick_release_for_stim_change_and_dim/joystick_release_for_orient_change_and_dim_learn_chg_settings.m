function p = joystick_release_for_orient_change_and_dim_learn_chg_settings
...
p.init.exptType         = 'joystick_release_for_stim_dim_and_orient_change_learn_chg';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
