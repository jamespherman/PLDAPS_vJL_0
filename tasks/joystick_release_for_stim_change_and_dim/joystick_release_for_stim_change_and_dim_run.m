...
if timeNow > p.trData.timing.lastFrameTime + ...
    ...
    if p.trVars.cueIsOn
        if p.stim.nStim > 1
            ...
            % colored portion:
            Screen('FrameArc', p.draw.window, ...
                p.draw.color.cueRing, ...
                p.draw.cueRingRect, ...
                p.draw.cueArcAngles(1,1), p.draw.cueArcAngles(1,2), ...
                p.draw.ringThickPix);

            % grey portion:
            Screen('FrameArc', p.draw.window, ...
                p.draw.clutIdx.expCueGrey_subCueGrey, ...
                p.draw.cueRingRect, ...
                p.draw.cueArcAngles(2,1), p.draw.cueArcAngles(2,2), ...
                p.draw.ringThickPix);
        else
