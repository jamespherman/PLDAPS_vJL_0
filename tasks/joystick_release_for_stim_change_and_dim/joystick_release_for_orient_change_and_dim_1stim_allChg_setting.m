function p = joystick_release_for_orient_change_and_dim_1stim_allChg_settings
%  p = joystick_release_for_orient_change_and_dim_1stim_allChg_settings
...
p.init.exptType         = 'joystick_release_for_stim_dim_and_orient_change_1stim_allChg';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
...
p.trVarsInit.satInit                  = 0.3;      % initial color saturation
...
p.trVarsInit.freeRewardProbability   = 0.0;      % How probable is it that the monkey will get a free reward in between trials?
