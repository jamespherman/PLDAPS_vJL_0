function p = joystick_release_for_fix_off_run(p)
...
switch p.trVars.currentState
    ...
    case p.state.dontMove
        ...
        % joystick has not been released: strobe  "hit" code to recording
        % system, log the time that the fixation hold duration requirement
        % was met, advance to the "hit" state, and play a tone indicating
