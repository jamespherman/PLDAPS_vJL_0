...
if p.trVars.temporalOverlap == 0    
    if p.trVars.numDots == 1
        % If presenting 1 stimulus, total duration should be between
        % duration of one stimulus and that total duration of two stimuli plus inter-stim-interval
        ...
        p.trVars.stimTwoDur         = unifrnd (0, p.trVars.stimDurMax);
