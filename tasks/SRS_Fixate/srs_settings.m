...
% Per Trial
p.status.ActualTrialType            = 0;    % 1 = Congruent ; 2 = Conflict
...
p.status.highRewardSide       = 0;      % 1=right, 2=left
...
p.init.strobeList = {...                
    ...
    'ActualTrialType',      'p.status.ActualTrialType'; ...     % 1 = Congruent ; 2 = Conflict
