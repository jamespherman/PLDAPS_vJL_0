function p = human_psychophysical_threshold_settings_orientation
%  p = human_psychophysical_threshold_settings_orientation
%
...
p.init.exptType         = 'human_psychophysics_orientation_discrimination';  % Which experiment are we running? <- IMPORTANT FOR TRIAL STRUCTURE CHOICE
...
p.trVarsInit.initQuestThreshGuess    = 45;       % initial guess of threshold value to pass to quest
p.trVarsInit.initQuestBetaGuess      = 3.5;      % what is our initial guess for beta?
p.trVarsInit.signalStrength          = 45;       % what is the signal strength for the upcoming trial (updated during experiment). This is also the assumed suprathreshold value.
p.trVarsInit.minSignalStrength       = 1;        % what is the smallest signal we want to test?
p.trVarsInit.maxSignalStrength       = 90;       % what is the largest signal we want to test?
p.trVarsInit.initQuestSD              =20;       % What is the SD on our initial threshold guess?
p.trVarsInit.supraSignalStrength     = 60;       % what is a signal stength that is very likely to be above threshold?
p.trVarsInit.questGrain              = 1;        % What is the "grain" size for representing our psychometric function?
