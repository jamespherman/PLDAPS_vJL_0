function p = human_psychophysical_threshold_settings_hue2
%  p = human_psychophysical_threshold_settings_hue2
%
...
p.trVarsInit.initQuestThreshGuess    = 90;       % initial guess of threshold value to pass to quest
...
p.trVarsInit.maxSignalStrength       = 180;      % what is the largest signal we want to test?
...
p.trVarsInit.initQuestSD             = ...
    (p.trVarsInit.maxSignalStrength - p.trVarsInit.minSignalStrength) / 6;  % What is the SD on our initial threshold guess?
p.trVarsInit.questGrain              = 1;
