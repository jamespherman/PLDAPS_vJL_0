...
switch p.trVars.currentState
    ...
    case p.state.checkLanding
        ...
        % For single-stimulus trials, mask the hidden target window
        % so saccades to the empty location count as inaccurate
...
if timeNow > frameDue
    ...
    if p.trVars.stimuliVisible
        ...
        % For single-stimulus trials, only the presented target is drawn.
