...
% start movie playback and start recording audio from input and playing
% back on output.
Screen('SetMovieTimeIndex', p.draw.movie.movieHandle, ...
    p.draw.movie.movieIndex);
Screen('PlayMovie', p.draw.movie.movieHandle, p.draw.movie.rate, 1, 1.0);
