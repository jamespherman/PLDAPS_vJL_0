...
% Overall high-reward choice rate across all valid successful two-target
% trials. Single-target instruction trials are excluded by isChoice.
overallHighReward = isChoice & isfinite(choseHighReward);
stats.pHighRewardOverall = safeMean(choseHighReward(overallHighReward));
stats.nHighRewardOverall = sum(overallHighReward);
...
statusLinesRight = { ...
    ...
    ' '; ...
    htmlSection('HIGH-REWARD CHOICE RATE', '#0072bd'); ...
    htmlLine('Conflict', probabilityString( ...
        stats.pHighRewardConflict, stats.nConflictHighReward), '#0072bd'); ...
    htmlLine('Congruent', probabilityString( ...
        stats.pHighRewardCongruent, stats.nCongruentHighReward), '#008000'); ...
    htmlLine('Overall', probabilityString( ...
        stats.pHighRewardOverall, stats.nHighRewardOverall), '#7030a0'); ...
    ' '; ...
