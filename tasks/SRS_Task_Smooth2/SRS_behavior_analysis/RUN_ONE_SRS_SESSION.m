...
% Analyser le bloc 8 jusqu'au dernier bloc disponible.
% Utiliser [9 Inf] pour exclure les huit premiers blocs.
% Utiliser [] pour analyser tous les blocs comme auparavant.
