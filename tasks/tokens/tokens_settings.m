...
p.trVarsInit.fixWin = 2.0;                  % Fixation window radius in degrees of visual angle. NOTE: The value of 10 in the .m file may have different units; adjust as needed[cite: 1].
