...
p.init.trialArrayColumnNames = {'dist', 'cueFile', 'isFixationRequired', 'isToken', 'trialCode', 'nReps'};
...
% The last column, nReps, is the number of trials of this type per block.
    ...
    % Columns: {dist, cueFile, isFixationRequired, isToken, trialCode, nReps}
    table = { ...
    % Normal Distribution Cues (dist=1)
    1, 'famNorm_01.jpg', true, true, 27001, nReps; ...
    1, 'famNorm_02.jpg', true, true, 27002, nReps; ...
    1, 'novNorm_01.jpg', true, true, 27003, nReps; ...
    % Uniform Distribution Cues (dist=2)
    2, 'famUni_01.jpg',  true, true, 27004, nReps; ...
    2, 'famUni_02.jpg',  true, true, 27005, nReps; ...
    2, 'novUni_01.jpg',  true, true, 27006, nReps; ...
    % Free Reward, Tokens (dist=0)
    0, 'blank.jpg',      false, true, 27007, nReps; ...
    % Free Reward, No Tokens (dist=0)
    0, 'blank.jpg',      false, false, 27008, nReps; ...
    };
end
