...
if ~strcmp(p.trVars.cueFile, 'blank.jpg')
    ...
    stimulus_folder = fullfile(p.init.pldapsFolder, 'stimuli', ...
        'tokens');
    ...
    if exist(image_path, 'file')
        ...
        [imgHeight, imgWidth, ~] = size(img_data);

        % Define the destination rectangle, centered on the screen
        p.stim.cue.rect = CenterRectOnPointd([0 0 imgWidth imgHeight], ...
