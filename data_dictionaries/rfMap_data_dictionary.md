...
| 16151-16157 | (reserved-but-unused) | — | Originally allocated for jitter / aperture features that were cancelled before implementation (see merge plan goal exclusions). Numbers stay reserved per the "holy" rule -- never strobed in any session, but do not reuse. |
