function p = scd_settings_nfl_eachChangeOnce
...
p.init.exptType         = 'feature_changes';  % Which experiment are we running? The one in which there are only saturation increase events to detect in the first block, then a 50/50 split of sat. inc. and contrast inc.
