function p = scd_settings_nflNoSgl
...
p.init.exptType         = 'nfl';  % Which experiment are we running? The full version with all trial types? The single-stimulus-only version? Something else?
